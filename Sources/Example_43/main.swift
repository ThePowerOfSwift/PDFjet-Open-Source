...
public class Example_43 {
    ...
    public init() throws {
        ...
        let stream = OutputStream(toFileAtPath: "Example_43.pdf", append: false)
        let pdf = PDF(stream!)
...
"Even so, unemployment has remained at less than half the EU average.")
        ...
        var points = text.getBeginParagraphPoints()
/*
        for point in points {
            print("x_begin == \(point[0])")
            print("y_begin == \(point[1])")
        }
*/
...
/*
            ...
            print("y_end == \(point[1])")
*/
            page.drawRect(point[0], point[1], 15.0, 15.0)
        }
