...
javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_06.java
javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_07.java
javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_08.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_09.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_10.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_11.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_12.java
...
javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_20.java
...
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_27.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_28.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_29.java
javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_30.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_31.java
...
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_35.java
...
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_39.java
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_40.java
...
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_44.java
...
# javac -encoding utf-8 -Xlint -cp .:PDFjet.jar Example_49.java
